...
function sortearAmigo() {
    ...
    resultado.innerHTML = ''; // borra los reultados anteriores 

    if (nombres.length < 2) {
        alert('Necesitas al menos dos nombres para sortear un amigo secreto.'); 
        return; //elegir un índice aleatorio
    }
    //se realizo una corrección: se quito el acento en el nombre de la variable
